...
const HeroSection = () => {
  return (
    <section className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] w-full">
      ...
      {/* Overlay text */}
      <div className="relative z-10 h-full flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-6 pt-16 md:pt-20">
      ...
      <div className="absolute bottom-12 left-0 right-0 z-10 flex justify-center px-4 md:justify-start md:left-24 md:right-auto md:px-0">
